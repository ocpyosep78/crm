<?php
/**
 * Xajax.class.php :: Main xajax class and setup file
 *
 * xajax version 0.2.4
...
{
	define ('XAJAX_JS_DIR', CLASSES_PATH.'Xajax/xajax_js');
}

if (!defined ('XAJAX_VERBOSE'))
{
	define ('XAJAX_VERBOSE', false);
}
...
class Xajax
{
	...
	function getJavascriptConfig()
	{
		...
		$html .= "var xajaxVerbose=".(int)XAJAX_VERBOSE.";\n";
	...
	{
		if ($sJsFile == NULL) $sJsFile = XAJAX_JS_DIR."/xajax.js";
