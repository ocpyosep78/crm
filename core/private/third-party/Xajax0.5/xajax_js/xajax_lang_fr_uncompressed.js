	...
	xajax.debug.text[104] = 'ENVOI DE LA REQUÈTE';
	xajax.debug.text[105] = 'ENVOYÉ [';
	xajax.debug.text[106] = ' octets]';
	xajax.debug.text[107] = 'APPEL : ';
	xajax.debug.text[108] = 'URI : ';
	xajax.debug.text[109] = 'INITIALISATION DE LA REQUÈTE';
	xajax.debug.text[110] = 'TRAITEMENT DES PARAMÈTRES [';
	xajax.debug.text[111] = ']';
	xajax.debug.text[112] = 'AUCUN PARAMÈTRE Á TRAITER';
	xajax.debug.text[113] = 'PRÈPARATION DE LA REQUÈTE';
	xajax.debug.text[114] = 'DÈBUT DE L\'APPEL XAJAX (d?pr?ci?: utilisez plut?t xajax.request)';
