...
class snp_EditItem extends Snippet
{
	...
	protected function assignVars()
	{
		...
		($realfields % 2) && array_splice($myData, $realfields, 0, ['' => '']);
		...
		$this->assign('inDialog', ($action == 'dialog'));
	...
	protected function _dialog()
	{
		...
		return $this->dialog($html, '#EditItem', ['title' => $title]);
	}
...
/******************************************************************************/
/****************** TODO : INTEGRATE FORMER VALIDATION CLASS ******************/
/******************************************************************************/
